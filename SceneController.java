...
public class SceneController {
	...
	public static Stage primaryStage;   //CHANGED ---------------------------------------
    public static CurrentUser global = new CurrentUser(); //CHANGED ---------------------------------------
	...
	@FXML
    private void switchToPMsg(ActionEvent event) throws IOException {      //CHANGED ---------------------------------------
		global.setUser("Patient");
	...
	@FXML
	private void switchToNMsg(ActionEvent event) throws IOException { 	//CHANGED ---------------------------------------
		global.setUser("Nurse");
	...
	@FXML
	private void switchToDMsg(ActionEvent event) throws IOException { //CHANGED ---------------------------------------
		global.setUser("Doctor");
